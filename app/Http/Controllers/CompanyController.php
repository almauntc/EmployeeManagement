...
class CompanyController extends Controller
{
    ...
    public function edit($id)
    {
        ...
        // Redirect to company list if updating country wasn't existed
    ...
    private function validateInput($request) {
        ...
        'email' => 'required|max:60|unique:company',
		'logo' => 'required|max:60|unique:company',
		'website' => 'required|max:60|unique:company'
    ]);
    }
}
