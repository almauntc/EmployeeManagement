  ...
  <div class="box-body">
      ...
      <form method="POST" action="{{ route('country.search') }}">
         ...
         @component('layouts.search', ['title' => 'Search'])
          @component('layouts.two-cols-search-row', ['items' => ['Company_Code', 'Name'], 
      ...
      <div class="row">
        <div class="col-sm-12">
          <table id="example2" class="table table-bordered table-hover dataTable" role="grid" aria-describedby="example2_info">
            <thead>
              <tr role="row">
                <th width="8%" tabindex="0" aria-controls="example2" rowspan="1" colspan="1" aria-label="country: activate to sort column ascending">Company Code</th>
                ...
                <th width="20%" class="sorting" tabindex="0" aria-controls="example2" rowspan="1" colspan="1" aria-label="country: activate to sort column ascending">Website</th>
				<th width="8%" tabindex="0" aria-controls="example2" rowspan="1" colspan="1" aria-label="country: activate to sort column ascending">Logo</th>
              ...
              <tr>
                ...
                <th width="20%" rowspan="1" colspan="1">Company Name</th>
				 <th width="20%" rowspan="1" colspan="1">Email</th>
				  <th width="20%" rowspan="1" colspan="1">Website</th>
				   <th width="8%" rowspan="1" colspan="1">Logo</th>
